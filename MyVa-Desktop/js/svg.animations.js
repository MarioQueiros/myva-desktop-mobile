if( document.createElement('svg').getAttributeNS ) {
	...
	Array.prototype.slice.call(document.querySelectorAll('#place-type input')).forEach(function (el, i) {
	    var svg = createSVGEl();
	...
	function resetRadio( el ) {
	    Array.prototype.slice.call(document.querySelectorAll('#place-type input')).forEach(function (el) {
